...
print(f'Максимальное количество жанров: {df["Number of genres"].max()}')
print('\n', '#' * 100, '\n')
# Бонусное задание
# Создай новый столбец, хранящий сезон, в котором было произведено последнее обновление ('Last Updated')
# приложения. Назови его 'Season'
def set_season(date):
    month = date.split()[0]
    seasons = {
