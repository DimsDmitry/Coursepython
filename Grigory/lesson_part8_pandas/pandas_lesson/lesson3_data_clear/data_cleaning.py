...
empty = df[pd.isnull(df['Rating'])]
print('Приложений, у которых не указан рейтинг:', len(empty))
...
df['Size'] = df['Size'].apply(set_size)  # применяет функцию set_size ко всему столбцу
print(df['Size'].value_counts())
