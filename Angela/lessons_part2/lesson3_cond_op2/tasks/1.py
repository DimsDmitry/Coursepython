...
answer = input().lower()
if answer == "да":
    taste = input('Мясо или молоко?').lower()
    if taste == 'мясо':
        meat = input('Говядина или курица?').lower()
        if meat == 'говядина':
            print('Говяжий стейк')
        elif meat == 'курица':
            print('Куриное филе в сырном соусе')
        else:
            print('Мясо по-французски')
    elif taste == 'молоко':
        choise = input('Что именно вы хотите?').lower()
        if choise == 'творог':
            print('Финский творожный пирог')
        elif choise == 'молоко':
            print('Молочный коктейль')
        else:
            print('Сырники')
    else:
        print('Мы не поняли что вам нужно, попробуйте вишнёвый пирог!')
