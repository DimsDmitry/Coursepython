...
score_text.set_text('Счёт:', 25, DARK_BLUE)
...
while True:
    ...
    if new_time - start_time >= 11:
        ...
        win.set_text("Время вышло!!!", 25, DARK_BLUE)
        win.draw(110, 180)
        break
    ...
    if points >= 5:
        ...
        win.set_text("Ты победил!!!", 25, DARK_BLUE)
        win.draw(140, 180)
        resul_time = Label(90, 230, 250, 250, LIGHT_GREEN)
        resul_time.set_text("Время прохождения: " + str(int(new_time - start_time)) + " сек", 25, DARK_BLUE)
