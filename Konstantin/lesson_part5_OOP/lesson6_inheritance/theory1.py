...
# наследование - это процесс создания одного класса на основе другого.
# дочерний класс получает все свойства и методы родительского, с возможностью дополнения
...
# множественное наследование - это наследование от двух и более классов одновременно
